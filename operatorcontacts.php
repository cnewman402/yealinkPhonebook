...
<head>
    ...
    <title>Gana Phonebook - Operators</title>
...
$xml->save("operators.xml");
 } 
 ?> 
 <form class="form-horizontal" action="operatorcontacts.php" method="post">
  <form class="form-horizontal" action="operatorcontacts.php" method="post">
<fieldset>
...
<!-- delete form -->
        ...
        <div class="row">
            <div class="col-md-6 portfolio-item col-lg-12">
                ...
                <h3>
                    <a href="#">Operator Contact Delete Form</a>
                </h3>
