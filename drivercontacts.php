...
<head>
    ...
    <title>Gana Phonebook - Drivers</title>
...
$xml->save("drivers.xml");
 } 
 ?> 
 <form class="form-horizontal" action="drivercontacts.php" method="post">
...
<!-- delete form -->
        ...
        <div class="row">
            <div class="col-md-6 portfolio-item col-lg-12">
                ...
                <h3>
                    <a href="#">Driver Contact Delete Form</a>
                </h3>
