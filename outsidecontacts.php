...
<head>
    ...
    <title>Gana Phonebook - Outsiders</title>
...
$xml->save("outsides.xml");
 } 
 ?> 
 <form class="form-horizontal" action="outsidecontacts.php" method="post">
<fieldset>
...
<!-- delete form -->
        ...
        <div class="row">
            <div class="col-md-6 portfolio-item col-lg-12">
                ...
                <h3>
                    <a href="#">Business Contact Delete Form</a>
                </h3>
