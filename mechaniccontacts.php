...
<head>
    ...
    <title>Gana Phonebook - Mechanics</title>
...
$xml->save("mechanics.xml");
 } 
 ?> 
 <form class="form-horizontal" action="mechaniccontacts.php" method="post">
<fieldset>
...
<!-- delete form -->
        ...
        <div class="row">
            <div class="col-md-6 portfolio-item col-lg-12">
                ...
                <h3>
                    <a href="#">Mechanic Contact Delete Form</a>
                </h3>
